    ...
    return (
        <section className="px-8 py-16">
            <div className="container mx-auto mb-20 text-center">
                ...
                <Typography
                    variant="lead"
                    className="mx-auto w-full lg:w-7/12 !text-gray-500" placeholder={undefined}
                    onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                    Ready to get started? Feel free to reach out and let&apos;s embark on a journey of innovation and
                    success.
                </Typography>
            </div>
                ...
                <Card shadow={true} className="container mx-auto border border-gray/50"
                    ...
                    <CardBody className="grid grid-cols-1 lg:grid-cols-7 md:gap-10"
                        ...
                        <div className="w-full col-span-3 rounded-lg h-full py-8 p-5 md:p-16 bg-gray-900">
                            ...
                            <Typography
                                variant="lead"
                                className="mx-auto mb-8 text-base !text-gray-500" placeholder={undefined}
                                onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
